...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Humflow — Talent Pipeline AI" },
      ...
      { property: "og:title", content: "Humflow — Talent Pipeline AI" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,400;0,9..40,500;1,9..40,400&family=Space+Grotesk:wght@500;700&family=JetBrains+Mono:wght@400&display=swap",
      },
    ],
  }),
